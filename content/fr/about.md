...
côtés à la fois, ce qu'elle doit produire comme sensation en jeu et ce qu'elle coûte à l'exécution.

L'essentiel de mon travail se situe entre le gameplay et le moteur. Il s'agit d'écrire des systèmes
que les game designers peuvent réellement utiliser, comme un éditeur nodal plutôt qu'une courbe de
difficulté codée en dur, ou des attaques data-driven plutôt qu'un rebuild à chaque réglage. Il
s'agit ensuite de s'assurer que ces systèmes tiennent la route sur un casque Quest ou sur Switch.
Intégration de SDK console, profilage, automatisation de build : le travail ingrat qui décide si un
jeu sort ou non.
